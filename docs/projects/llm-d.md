...
llm-d sits behind KServe (v0.19.0 integrates directly with it) as the inference engine, while the Gateway API Inference Extension handles model-aware traffic routing in front.
