...
llm-d sits behind KServe (v0.20.0 integrates directly with it) as the inference engine, while the Gateway API Inference Extension handles model-aware traffic routing in front.

## Current status
- **CNCF status:** Not a CNCF project
- **Latest version:** v0.9.0 (August 2026)
