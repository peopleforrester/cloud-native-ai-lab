...
3. **Topology awareness is table stakes.** Every major scheduler, including Kueue, Volcano (with HyperNode CRD for NVLink/InfiniBand discovery), NVIDIA KAI Scheduler, and Run:ai, now offers topology-aware scheduling. NVIDIA's ComputeDomains enable multi-node NVLink on GB200 NVL72 systems through DRA.
